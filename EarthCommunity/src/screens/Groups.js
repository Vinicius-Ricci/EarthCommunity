...
export default function Groups() {
  ...
  const filteredGroups = selectedTab === 'seusGrupos'
    ? seusGrupos.filter(group => group.createdByUser.user._id === userId)
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
          style={styles.tabText}>Seus Grupos</Text>
          </TouchableOpacity>
          <TouchableOpacity
